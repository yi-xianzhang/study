...
public class IntegerDemo extends AbstractTestTemplate<Integer> {
	...
	private void toString(int i, int radix) {
		System.out.println(Integer.class.getTypeName() + "的静态方法 toString (" + i + "," + radix + " ) := "
			+ Integer.toString(i, radix));
	}

	/**
	 * {@link Integer}类的静态方法{@link Integer#toUnsignedString(int, int)}测试。</br>
	 * {@link Integer#digits}数组相关联。
	...
	private void toUnsignedString(int i, int radix) {
		System.out.println(Integer.class.getTypeName() + "的静态方法 toUnsignedString (" + i + "," + radix + " ) := "
	...
	private void toRadixString(int i, int radix) {
		...
		System.out.println(Integer.class.getTypeName() + "的静态方法 " + methods + " (" + i + " ) := "
			+ value);
	}
	...
	private void numberOfLeadingZeros(int value) {
		System.out.println(Integer.class.getTypeName() + "的静态方法 toUnsignedString (" + value + " ) := "
